...
/*   Updated: 2023/11/05 18:11:22 by yeoshin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strtrim(char const *s1, char const *set)
{
	...
	if (start == (int)ft_strlen(s1))
		return (ft_strdup(""));
	while (ft_strchr(set, (int)string[(int)ft_strlen(s1) - end - 1]) != NULL)
		end ++;
	ret_string = (char *)malloc((int)ft_strlen(s1) - end - start + 1);
	if (ret_string == NULL)
		return (NULL);
